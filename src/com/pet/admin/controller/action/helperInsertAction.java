...
public class helperInsertAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(adminLogin == null)
			...
			phvo.setName(multi.getParameter("name"));
			phvo.setSex(Integer.parseInt(multi.getParameter("sex")));
			phvo.setPhone(multi.getParameter("phone"));
			phvo.setEmail(multi.getParameter("email"));
			phvo.setHgroup(Integer.parseInt(multi.getParameter("hgroup")));
